...
const ItemList = ({question, index, questions, setQuestions}) => {
    ...
    return (
        ...
        <li className={styles.item}>
            ...
            {upForm && <Edit questions={questions} question={question} upForm={upForm} setQuestions={setQuestions} setUpForm={setUpForm} />}
        </li>
            { warning && <div className={styles.warning} onClick={() => setWarning(!warning)}>
